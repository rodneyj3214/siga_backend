...
class CreateAcademicFormationsTable extends Migration
{
    public function up()
    {
        Schema::connection('pgsql-app')->create('academic_formations', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('degree_id')->comment('Nombre del titulo obtenido')->constrained('app.catalogues');
    ...
    {
        Schema::connection('pgsql-app')->dropIfExists('academic_formations');
    }
}
